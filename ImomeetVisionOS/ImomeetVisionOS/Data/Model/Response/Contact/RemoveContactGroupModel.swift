...
class RemoveContactGroupModel: Codable, Identifiable { 
    public let code: Int?
    ...
    public var isRemoveContactGroupSuccess: Bool {
        return info == "Ok" && code == 1
    }
    
    public var errorX: XpertError? {
        guard !isRemoveContactGroupSuccess,
           let code = code,
