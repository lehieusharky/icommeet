//
//  WatermarkHQPhotosView.swift
//  ImomeetVisionOS
//
//  Created by Long Nguyen on 09/11/2023.
//

import SwiftUI

struct WatermarkHQPhotosView: View {
    ...
    var body: some View {
        NavigationStack{
            ...
            .navigationTitle("id_watermark_setting_hdphoto".localizedLanguage())
        }
    }
}
